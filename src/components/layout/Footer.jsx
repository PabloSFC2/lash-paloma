    ...
    <footer className="bg-gray-800 text-white-pure py-8 mt-16">
      <div className="container mx-auto px-6 text-center">
        ...
        <div className="flex justify-center space-x-6 mb-4">
          ...
          <a href="https://www.instagram.com/ciliospaloma_correa/" target="_blank" rel="noopener noreferrer" className="text-white-pure hover:text-golden-light transition-colors duration-300">
          ...
          <a href="https://www.facebook.com/profile.php?id=100016059192740" target="_blank" rel="noopener noreferrer" className="text-white-pure hover:text-golden-light transition-colors duration-300">
            {/* <FaFacebook size={24} /> */}
          </a>
          <a href="https://wa.me/5511989927677" target="_blank" rel="noopener noreferrer" className="text-white-pure hover:text-golden-light transition-colors duration-300">
            {/* <FaWhatsapp size={24} /> */}
          </a>
        </div>
        <div className="text-sm">
          <p>Email: palomasantoslv2@gmail.com</p>
          <p>Telefone: (11) 98992-7677</p>
        </div>
      </div>
    </footer>
  );
